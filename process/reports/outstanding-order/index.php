...
if(isset($_GET['draw']))
{
    ...
    if($filter)
    {
        ...
        {
            if($f_key == 'status_order' && $f_value == '- Pilih -') continue;
...
$title = 'Laporan Outstanding Order (Belum Close)';
Page::setActive("kaosful.reports.outstanding_order");
Page::setTitle($title);
Page::setBreadcrumbs([
    [
        'url' => routeTo('/'),
...
return view('kaosful/views/reports/outstanding-order/index', compact('fields'));