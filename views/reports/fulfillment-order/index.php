...
<div class="card mb-3">
    <div class="card-header d-flex flex-grow-1 align-items-center">
        <p class="h4 m-0">Laporan Pemenuhan Order</p>
    </div>
</div>
<div class="card mb-3">
    <div class="card-body">
        <form action="" onsubmit="window.reportFulfillment.draw(); return false" class="d-flex flex-wrap" style="gap:10px;">
            ...
            <div class="form-group mb-1">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    &nbsp;
                    <button type="button" class="btn btn-secondary w-100" onclick="downloadReportFulfillment()">Download</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped datatable-report-fulfillment" style="width:100%">
                <thead>
                    <tr>
                        <th width="20px">#</th>
                        <?php 
